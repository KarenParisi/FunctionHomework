...
prices.forEach(function(item){
  document.querySelector("#answer2").innerHTML += item.title + "<br />";
})

var titles = prices.map(function (item) {
  return item.title;
});
console.log(titles);

var gbpCodes = items.filter(function (gbp) {
  return gbp.currency_code === 'GBP';
});

gbpCodes.forEach(function(item) {
    document.querySelector('#answer3').innerHTML = item.title + " " + item.price
}); 
...
material.forEach(function(item){
  document.querySelector("#answer5").innerHTML += item.title + item.materials.length + item.materials
 });

var inHouse  = items.filter(function(item){
...
console.log(inHouse);
inHouse.forEach(function(item) { 
  document.querySelector("#answer6").innerHTML = inHouse.length
});
